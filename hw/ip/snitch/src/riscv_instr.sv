...
package riscv_instr;
  ...
  localparam logic [31:0] FREP_O             = 32'b?????????????????000????10001011;
  localparam logic [31:0] FREP_I             = 32'b?????????????????000????00001011;
  ...
  localparam logic [31:0] VLX8_V             = 32'b???100?00000?????000?????0000111;
  localparam logic [31:0] VLX16_V            = 32'b???100?00000?????101?????0000111;
  localparam logic [31:0] VLX32_V            = 32'b???100?00000?????110?????0000111;
  localparam logic [31:0] VLX64_V            = 32'b???100?00000?????111?????0000111;
  ...
  localparam logic [31:0] VFXMACC_VF         = 32'b100101???????????101?????1010111;
  localparam logic [31:0] VFXMUL_VF          = 32'b100110???????????101?????1010111;
  localparam logic [31:0] VFXMACC_VRF        = 32'b?????00??????????010?????0001011;
  localparam logic [31:0] VFXMUL_VRF         = 32'b?????01??????????010?????0001011;
  localparam logic [31:0] VVENTCLR           = 32'b00000110000000000010000000001011;
  ...
  localparam logic [31:0] P_VLE8_V_RRPOST    = 32'b110000???????????000?????1111011;
  localparam logic [31:0] P_VLE16_V_RRPOST   = 32'b110000???????????101?????1111011;
  localparam logic [31:0] P_VLE32_V_RRPOST   = 32'b110000???????????110?????1111011;
  localparam logic [31:0] P_VLE64_V_RRPOST   = 32'b110000???????????111?????1111011;
  localparam logic [31:0] P_VLX8_V_RRPOST    = 32'b110001???????????000?????1111011;
  localparam logic [31:0] P_VLX16_V_RRPOST   = 32'b110001???????????101?????1111011;
  localparam logic [31:0] P_VLX32_V_RRPOST   = 32'b110001???????????110?????1111011;
  localparam logic [31:0] P_VLX64_V_RRPOST   = 32'b110001???????????111?????1111011;
  localparam logic [31:0] P_FLB_RRPOST       = 32'b1010000??????????000?????1111011;
  localparam logic [31:0] P_FLH_RRPOST       = 32'b1010000??????????001?????1111011;
  localparam logic [31:0] P_FLW_RRPOST       = 32'b1010000??????????010?????1111011;
  localparam logic [31:0] P_FLD_RRPOST       = 32'b1010000??????????011?????1111011;
  ...
  localparam logic [11:0] CSR_VLEFORWARD = 12'h7c2;
  localparam logic [11:0] CSR_VTLREG = 12'h7c3;
  localparam logic [11:0] CSR_VTLIDXW = 12'h7c4;
  localparam logic [11:0] CSR_VTLBLKS = 12'h7c5;
  localparam logic [11:0] CSR_VTLRATIO = 12'h7c6;
