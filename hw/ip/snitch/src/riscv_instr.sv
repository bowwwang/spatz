...
package riscv_instr;
  ...
  localparam logic [31:0] MXMACC_VV          = 32'b101100???????????010?????1010111;
  localparam logic [31:0] MXMACC_VX          = 32'b101100???????????110?????1010111;
  localparam logic [31:0] MXDOTP_VV          = 32'b101110???????????010?????1010111;
  localparam logic [31:0] MXDOTP_VX          = 32'b101110???????????110?????1010111;
  localparam logic [31:0] MXFMACC_VV         = 32'b110111???????????001?????1010111;
  localparam logic [31:0] MXFMACC_VF         = 32'b110111???????????101?????1010111;
  localparam logic [31:0] MLE8_V_A           = 32'b0010010??????????000?????1110111;
  localparam logic [31:0] MLE8_V_B           = 32'b0010100??????????000?????1110111;
  localparam logic [31:0] MLE8_V_C           = 32'b0000000??????????000?????1110111;
  localparam logic [31:0] MLE16_V_A          = 32'b0010010??????????101?????1110111;
  localparam logic [31:0] MLE16_V_B          = 32'b0010100??????????101?????1110111;
  localparam logic [31:0] MLE16_V_C          = 32'b0000000??????????101?????1110111;
  localparam logic [31:0] MLE32_V_A          = 32'b0010010??????????110?????1110111;
  localparam logic [31:0] MLE32_V_B          = 32'b0010100??????????110?????1110111;
  localparam logic [31:0] MLE32_V_C          = 32'b0000000??????????110?????1110111;
  localparam logic [31:0] MLE64_V_A          = 32'b0010010??????????111?????1110111;
  localparam logic [31:0] MLE64_V_B          = 32'b0010100??????????111?????1110111;
  localparam logic [31:0] MLE64_V_C          = 32'b0000000??????????111?????1110111;
  localparam logic [31:0] MSE8_V_A           = 32'b0010011??????????000?????1110111;
  localparam logic [31:0] MSE8_V_B           = 32'b0010101??????????000?????1110111;
  localparam logic [31:0] MSE8_V_C           = 32'b0000001??????????000?????1110111;
  localparam logic [31:0] MSE16_V_A          = 32'b0010011??????????101?????1110111;
  localparam logic [31:0] MSE16_V_B          = 32'b0010101??????????101?????1110111;
  localparam logic [31:0] MSE16_V_C          = 32'b0000001??????????101?????1110111;
  localparam logic [31:0] MSE32_V_A          = 32'b0010011??????????110?????1110111;
  localparam logic [31:0] MSE32_V_B          = 32'b0010101??????????110?????1110111;
  localparam logic [31:0] MSE32_V_C          = 32'b0000001??????????110?????1110111;
  localparam logic [31:0] MSE64_V_A          = 32'b0010011??????????111?????1110111;
  localparam logic [31:0] MSE64_V_B          = 32'b0010101??????????111?????1110111;
  localparam logic [31:0] MSE64_V_C          = 32'b0000001??????????111?????1110111;
  localparam logic [31:0] MSETTILEM          = 32'b001100000000?????111?????1110111;
  localparam logic [31:0] MSETTILEK          = 32'b010100000000?????111?????1110111;
  localparam logic [31:0] MSETTILEN          = 32'b011100000000?????111?????1110111;
  ...
  localparam logic [31:0] VLXBLKEI8_V        = 32'b0001100??????????000?????0101011;
  localparam logic [31:0] VLXBLKEI16_V       = 32'b0001100??????????101?????0101011;
  localparam logic [31:0] VSXBLKEI8_V        = 32'b0001101??????????000?????0101011;
  localparam logic [31:0] VSXBLKEI16_V       = 32'b0001101??????????101?????0101011;
  localparam logic [31:0] VSETBLKLEN         = 32'b000111100000?????000000000101011;
  /* CSR Addresses */
  ...
  localparam logic [11:0] CSR_MTYPE = 12'hc43;
  localparam logic [11:0] CSR_TILEM = 12'hc40;
  localparam logic [11:0] CSR_TILEK = 12'hc42;
  localparam logic [11:0] CSR_TILEN = 12'hc41;
